...
public class Order {
	...
	* An array of request-related
	 * [HATEOAS links](/docs/api/reference/api-responses/#hateoas-links).
	 * To complete payer approval,
	 * use the `approve` link with the `GET` method.
	*/
	...
	/**
	 * Deprecated using payment_source
	...
	* Required
	 ...
	 * Each purchase unit represents either a full or partial order
	 * that the customer intends to purchase from the merchant.
	*/
